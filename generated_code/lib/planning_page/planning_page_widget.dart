...
import 'planning_page_model.dart';
export 'planning_page_model.dart';

/// AVARYN Alpha product route backed by the existing RLS-scoped Phase 4/5
/// contracts.
class PlanningPageWidget extends StatefulWidget {
  const PlanningPageWidget({super.key});

  static String routeName = 'PlanningPage';
  static String routePath = '/planning';

  @override
  State<PlanningPageWidget> createState() => _PlanningPageWidgetState();
}

class _PlanningPageWidgetState extends State<PlanningPageWidget> {
  late PlanningPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlanningPageModel());

...
import 'today_dashboard_page_model.dart';
export 'today_dashboard_page_model.dart';

/// AVARYN Alpha product route backed by the existing RLS-scoped Phase 4/5
/// contracts.
class TodayDashboardPageWidget extends StatefulWidget {
  const TodayDashboardPageWidget({super.key});

  static String routeName = 'TodayDashboardPage';
  static String routePath = '/today';

  @override
  State<TodayDashboardPageWidget> createState() =>
      _TodayDashboardPageWidgetState();
}

class _TodayDashboardPageWidgetState extends State<TodayDashboardPageWidget> {
  late TodayDashboardPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TodayDashboardPageModel());

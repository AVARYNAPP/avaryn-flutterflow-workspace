...
class AVARYNAlphaSupabaseUser extends BaseAuthUser {
  AVARYNAlphaSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> aVARYNAlphaSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = AVARYNAlphaSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}

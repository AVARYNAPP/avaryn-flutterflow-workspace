...
class _AvarynStableAccountRuntimeState
  ...
  Future<void> _load({String? selectOrganizationId}) async {
    ...
    try {
      ...
      final selected = organizations.any(
  ...
  Future<void> _respondToInvitation({String? initialToken}) async {
    final values = initialToken == null
        ? await _textDialog(
  ...
  List<String> _rowsOfStrings(dynamic value) => value is List
            ...
            for (final organization in _organizations)
              Card(
                ...
                child: ListTile(
                  ...
                  title:
                      Text(organization['name']?.toString() ?? 'Stalaccount'),
                  subtitle: Text(
        ...
        child: Column(
          ...
          children: [
            _sectionHeader(
              ...
              action: _can('organization.memberships.manage')
                  ? TextButton.icon(
            ...
            for (final membership in memberships)
              ListTile(
                ...
                trailing: _can('organization.memberships.manage') &&
            ...
            for (final invitation in invitations)
              ListTile(
                ...
                trailing: invitation['status'] == 'pending'
                    ? IconButton(
                        onPressed:
                            _busy ? null : () => _revokeInvitation(invitation),
          ...
          children: [
            ...
            for (final role in roles)
              ListTile(
                ...
                trailing: _can('organization.roles.manage') &&
                        role['is_reserved'] != true
                    ? IconButton(
                        onPressed:
        ...
        child: Column(
          ...
          children: [
            _sectionHeader(
              ...
              action: _can('organization.horse_links.manage')
                  ? TextButton.icon(
                  ...
                  children: [
                    if (link['status'] == 'proposed' &&
                      ...
                      PopupMenuButton<String>(
                        ...
                        itemBuilder: (_) => [
                          if (link['initiating_context'] == 'horse') ...const [
                            PopupMenuItem(
                              value: 'accept',
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            _sectionHeader(
              'Verblijfshistorie',
              action: _can('organization.residencies.manage')
                  ? TextButton.icon(
            ...
            for (final residency in residencies)
              ListTile(
                ...
                trailing: residency['status'] == 'active'
                    ? IconButton(
                        onPressed:

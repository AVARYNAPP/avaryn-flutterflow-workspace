...
class _AvarynHorseAccountRuntimeState extends State<AvarynHorseAccountRuntime> {
  ...
  Future<void> _load({String? selectHorseId}) async {
    ...
    try {
      ...
      final heroPhotoUrl = selectedHorse == null
          ? null
          : await _loadPhotoUrl(
  ...
  Future<String?> _loadPhotoUrl(
    ...
    try {
      final variantBody = variant == 'thumbnail'
  ...
  String? _dateIso(DateTime? value) => value == null
      ? null
  ...
  Future<bool> _confirmDiscard() async =>
      await showDialog<bool>(
        context: context,
        builder: (context) => _horseModalTheme(
          context,
          AlertDialog(
            ...
            child: AlertDialog(
              ...
              title: Column(
                ...
                children: [
                  ...
                  Text(
                    horse == null ? 'Paard toevoegen' : 'Profiel bewerken',
                ...
                FilledButton.icon(
                  ...
                  onPressed: saving
                      ...
                      : () async {
                          ...
                          try {
                            final horseId = await _persistHorseProfile(
                              horse: horse,
        ...
        child: InkWell(
          ...
          onTap: () async {
            ...
            final picked = await showDatePicker(
              context: context,
              builder: (pickerContext, child) => _horseModalTheme(
                pickerContext,
  ...
  Uint8List _buildPhotoThumbnail(Uint8List bytes, String mimeType) {
    ...
    while (maxDimension >= 192) {
      ...
      final encoded = mimeType == 'image/jpeg'
  ...
  Future<void> _pickProfilePhoto() async {
    ...
    try {
      ...
      final raw = error.toString();
      setState(
        () => _error = raw.contains('MEDIA_CONTENT_TYPE_INVALID') ||
        ...
        child: ConstrainedBox(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Align(
                    alignment: Alignment.centerLeft, child: _AvarynWordmark()),
  ...
  Widget _profileHeader(
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final heroHeight = compactIdentity
            ? (compact ? 300.0 : 280.0)
            : (compact ? 520.0 : 460.0);
        return ClipRRect(
  ...
  Widget _heroImage(String horseId) => _heroPhotoUrl == null
      ? _horseFallbackImage()
      : Image.network(
          _heroPhotoUrl!,
          fit: BoxFit.cover,
            ...
            if (_scheduleAgenda)
              for (final period in const [
                ...
                ChoiceChip(
                  ...
                  onSelected: (_) =>
                      setState(() => _schedulePeriodMode = period.$1),
                ),
          ],
        ),
        if (_scheduleAgenda) ...[
  ...
  Future<void> _setScheduleState(
    ...
    await _saveScheduleItem(
      ...
      end: item['scheduled_end_at'] == null
          ? null
  ...
  Future<void> _showScheduleEditor({Map<String, dynamic>? item}) async {
    ...
    var end = item?['scheduled_end_at'] == null
    ...
    await showModalBottomSheet<void>(
      ...
      useSafeArea: true,
      backgroundColor: _panelTone,
      builder: (sheetContext) => _horseModalTheme(
        sheetContext,
        StatefulBuilder(
    ...
    required ValueChanged<_ScheduleRangeSelection> onChanged,
      ...
      Padding(
        ...
        child: OutlinedButton.icon(
          ...
          onPressed: () async {
            final picked =
                await _showScheduleRangePlanner(start: start, end: end);
  ...
  String _shortMonthLabel(int month) => const [
        'jan',
        'feb',
        'mrt',
        'apr',
                ...
                children: [
                        ...
                        child: OutlinedButton.icon(
                          onPressed: () async {
                            ...
                            setSheetState(() {
                              ...
                              final safeDuration = duration.isNegative ||
                        ...
                        child: OutlinedButton.icon(
                          onPressed: () async {
                            ...
                            setSheetState(() {
                              ...
                              validation = selectedEnd.isBefore(selectedStart)
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: FilledButton(
                          onPressed: selectedEnd.isBefore(selectedStart)
                              ? null
                              : () => Navigator.pop(
                                    sheetContext,
                ...
                if (cell < leading)
                  ...
                  Builder(
                    builder: (context) {
                      ...
                      final inRange = !dayValue.isBefore(rangeStart) &&
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color: activeDays.contains(day)
                                      ? (focused ? Colors.white : _roseSoftTone)
                                      : Colors.transparent,
                                ),
                              ),
                            ],
          ...
          children: [
            SizedBox(
              ...
              child: Text(
                ...
                style: TextStyle(
                    color: _roseSoftTone, fontWeight: FontWeight.w700),
              ),
            ),
            const SizedBox(width: 10),
            Expanded(
  ...
  Map<String, dynamic>? _activeFeedingPlan({
    ...
    final activeTemporary = temporaryPlans.where((plan) {
          ...
          children: [
            Row(
              children: [
                ...
                if (canEdit)
                  TextButton.icon(
                    onPressed: () => _showFeedingRoundEditor(
  ...
  Future<void> _showFeedingRoundEditor({
    ...
    var until = _dateValue(plan?['effective_until'])?.toLocal() ??
                    ...
                    Expanded(
                      child: FilledButton(
                        onPressed: saving
                            ? null
                            : () async {
                                final validation = _validateFeedingDrafts(
                                  products,
                                  planType: planType,
                                  from: from,
                                  until: until,
  ...
  List<_FeedingProductDraft> _feedingDraftsForRound(
    ...
    return items.map((item) {
      ...
      return _FeedingProductDraft(
        ...
        quantity: quantity.endsWith('.0000')
            ? quantity.substring(0, quantity.length - 5)
            : quantity,
        unitCode: _feedingKnownUnits.contains(item['unit_code']?.toString())
  ...
  Map<String, dynamic>? _feedingDisplayVersion(Map<String, dynamic>? plan) {
    ...
    return versions.cast<Map<String, dynamic>?>().firstWhere(
          (version) =>
              version?['feeding_plan_version_id']?.toString() == activeId,
          orElse: () => versions.isEmpty ? null : versions.first,
        );
  }
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: const [
                ...
                DropdownMenuItem(
                    value: 'roughage', child: Text('Hooi / ruwvoer')),
                DropdownMenuItem(
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    decoration:
                        const InputDecoration(labelText: 'Hoeveelheid *'),
                  ),
                ),
                const SizedBox(width: 10),
                Expanded(
                  child: DropdownButtonFormField<String>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(
                          value: 'scoop', child: Text('maatschep')),
  ...
  Future<void> _showTemporaryPlanEndEditor(Map<String, dynamic> plan) async {
    ...
    final now = DateTime.now();
    final today = DateTime(now.year, now.month, now.day);
    var selectedUntil = today.isBefore(from)
        ? from
  ...
  Future<void> _confirmRemoveTemporaryPlan(Map<String, dynamic> plan) async {
    final confirmed = await showDialog<bool>(
      context: context,
      builder: (dialogContext) => _horseModalTheme(
        dialogContext,
        AlertDialog(
  ...
  String _feedingProductType(Map<String, dynamic> item) {
    ...
    if (const {
      ...
      'oil',
      'other',
    }.contains(variant)) return variant!;
  ...
  String _feedingProductDescription(Map<String, dynamic> item) {
    ...
    if (const {
      ...
      'oil',
      'other',
    }.contains(variant)) return _textValue(item['product_brand']);

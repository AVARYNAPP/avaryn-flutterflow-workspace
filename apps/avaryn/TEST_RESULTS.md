...
Lokale kandidaat: `C010-V8-PRODUCTIZATION-20260912-04`, versie0.10.8/build4, entry `app-5FOLTYRW.js`; nog niet gepubliceerd.
Kandidaat03 is vastgelegd in officieel checkpoint `13a599996ca60abcb45dabec08f9aef5d3a08940` en gepubliceerd via Sites-commit `b8352c6b25a009d00df5c5012b5f8a5cf270c2aa`, deployment `appgdep_6aa509a6a8548191951789693157bae2` succeeded. Bewijs: `candidate03-checkpoint.json` en `candidate03-online-publication.json`. De tabel bewaart kandidaat02- en historisch bewijs; voor kandidaat04 is geen nieuwe volledige suite uitgevoerd.

| Onderdeel | Resultaat | Grens van het bewijs |
| --- | --- | --- |
| Gezamenlijke JavaScript-/Edgeproductsuite, kandidaat02 | 926 tests:924 PASS,0 FAIL,2 SKIP; hergebruikt als baseline voor kandidaat04 | Twee optionele liveproeven zijn niet uitgevoerd; geen nieuwe volledige run |
...
Resterende gates: GitHubpush met het juiste AVARYN-account, nog niet bewezen managed media-/lifecyclegevallen, kandidaat04-publicatie en callback-/authacceptatie, daadwerkelijke wachtwoordreset, HTTPS/aliascontrole, native installatiebewijs, iOS simulator/archive, signing en testdistributie. Zie [voortgang](../../docs/status/V8_PRODUCTIZATION_PROGRESS.md) en [releaseprocedure](RELEASES.md).

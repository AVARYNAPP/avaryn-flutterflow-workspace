...
import 'package:flutterflow_generated/custom_code/widgets/avaryn_horse_avatar.dart';
import 'package:flutterflow_generated/flutter_flow/custom_functions.dart';
...
String _feedingRoundLabel(String roundId) =>
    _feedingRoundDefinitions
        .firstWhere(
...
class _AvarynDailyFeedingRuntimeState extends State<AvarynDailyFeedingRuntime> {
  ...
  void initState() {
    super.initState();
    _selectedDate =
        _feedingParseDateKey(FFAppState().selectedFeedingDateKey) ??
  ...
  Future<void> _editDefaultResponsible(String roundId) async {
    ...
    final result = await showModalBottomSheet<String>(
      ...
      builder:
          (sheetContext) => _ResponsiblePickerSheet(
  ...
  Future<void> _editRoundTime(String roundId) async {
    ...
    final result = await showModalBottomSheet<DateTime>(
      ...
      backgroundColor: Colors.transparent,
      builder:
          (sheetContext) => _AvarynFeedingTimeWheel(
  ...
  void _saveRoundConfig(
    ...
    final updated = FeedingRoundConfigDataStruct(
      ...
      displayLabel:
          source.displayLabel.trim().isEmpty
  ...
  Future<void> _editDateAssignment(String roundId) async {
    ...
    final result = await showModalBottomSheet<_ExceptionDraft>(
      ...
      backgroundColor: Colors.transparent,
      builder:
          (sheetContext) => _AssignmentExceptionSheet(
  ...
  Widget _buildExecution(BuildContext context) {
    final theme = FlutterFlowTheme.of(context);
    final roundId =
        FFAppState().selectedFeedingRoundId.trim().isEmpty
            ? 'morning'
  ...
  Widget _buildTodayCard(BuildContext context) {
    ...
    final due =
        unfinished.where((summary) {
          final time =
              summary.config.plannedTime ??
...
class _ResponsiblePickerSheetState extends State<_ResponsiblePickerSheet> {
  ...
  void initState() {
    super.initState();
    _choice =
        widget.initialUserId == widget.currentUserId
